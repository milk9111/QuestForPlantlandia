...
public class LeafSlap : Move
{
    ...
    private IEnumerator Damage()
    {
        ...
        if (result.Item1)
        {
            ...
            _model.dialogueText.text = "Leaf Slap was successful!";
        }
        else
        {
            _model.dialogueText.text = "Leaf Slap was blocked!";
        }
        ...
        _model.dialogueText.text = "Leaf Slap caused an itchy rash!";
